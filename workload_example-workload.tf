module "example_workload" {
  source              = "git::https://github.com/blinqas/station.git?ref=1.3.1"
  ...
  tfe = {
    ...
    module_outputs_to_workspace_var = {
      groups = true #This will output the groups you create to the workloads TFC as a variable you can reference
    }
  }
  # We create a basic group Entra ID securtiy group that can be used by the workload
  groups = {
    example_group = {
